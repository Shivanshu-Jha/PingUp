                ...
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form className='space-y-4' onSubmit={e=>toast.promise(
                        ...
                        <div className='flex justify-end space-x-3 pt-6'>
                            ...
                            <button type='submit' className='px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer active:scale-95'>Save Changes</button>
                        </div>
