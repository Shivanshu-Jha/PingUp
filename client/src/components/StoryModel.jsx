...
const StoryModel = ({ setShowModel, fetchStories }) => {
    ...
    const bgColors = ['#7a84f2', '#7c3aed', '#db2777', '#e11d48', '#ca8a04', '#0d9488']
        ...
        <div className='fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4'>
            <div className='w-full max-w-md'>
                ...
                <button onClick={() => toast.promise(handleCreateStory(),
                    { loading: 'Saving...', })} className='flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-500 hover:to-purple-700 active:scale-95 transition cursor-pointer'>
